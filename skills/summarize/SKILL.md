...
### Convert + summarize with GPT-5.4-mini (pass context!)
...
3) run `pi --provider openai-codex --model gpt-5.4-mini` (no-tools, no-session) to summarize using your extra prompt
